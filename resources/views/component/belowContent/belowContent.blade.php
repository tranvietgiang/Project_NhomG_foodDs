<section class="fd-section fd-container">
    <div class="fd-panel">
        <div class="fd-section-head">
            <div>
                <p class="fd-eyebrow">Gợi ý hôm nay</p>
                <h2 class="fd-title">Sản phẩm nên thử</h2>
            </div>
                ...
                <article class="fd-card" style="{{ $product->quantity_store > 0 ? '' : 'opacity:.55' }}">
                    ...
                    <div class="fd-card-body">
                        ...
                        <div class="fd-stars">
                            ...
                            <span class="fd-muted">(0)</span>
                        </div>
                        <div class="fd-muted">Còn {{ $product->quantity_store }} sản phẩm</div>
                        <div class="fd-price-line">
                            <div>
                                <div class="fd-price">{{ number_format($product->product_price) }}đ</div>
                                <span class="fd-old-price">{{ number_format($oldPrice) }}đ</span>
                            ...
                            @else
                                <span class="fd-sale">Hết hàng</span>
                            @endif
                        </div>
                    </div>
                </article>
