...
Route::get('/content', [ProductController::class, 'showContent'])->name('products.content');

// Admin Authentication Routes 
Route::get('/admin', [App\Http\Controllers\LoginController::class, 'showLoginForm'])->name('admin.login');
Route::post('/admin', [App\Http\Controllers\LoginController::class, 'login'])->name('admin.auth');
